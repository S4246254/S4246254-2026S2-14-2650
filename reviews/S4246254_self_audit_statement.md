...
Star ratings are text rather than images throughout. The visual bar is two stacked spans
of star characters marked `aria-hidden="true"`, and the value beside it is readable text
— "4.5 out of 5, from 64 reviews". No rating is conveyed by the graphic or by colour
alone; the number is always stated.
...
average is 4.14, which is what the displayed 4.1 rounds to. The bar widths derive from
those proportions.
